 ...
 *
 * 1. Bundles leviathan.tamper-entry.ts → leviathan.bundle.js
 * 2. Reads src/template.html, src/style.css, src/app.js
 * 3. Replaces placeholders and writes dist/index.html
 *
 * Do NOT pass --minify to Bun.build here. The minifier renames class internal
 * properties, which breaks leviathan code that reads named properties on its
 * own instances.
 */

import { mkdirSync, statSync } from 'node:fs';

const entryPath    = './leviathan.tamper-entry.ts';
...
process.stdout.write('Bundling leviathan-crypto (tamper)...\n');
